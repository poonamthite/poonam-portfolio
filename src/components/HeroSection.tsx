    ...
    <section className="relative min-h-auto flex items-start bg-gradient-to-br from-primary-50 via-white to-secondary-50 overflow-hidden py-10">
      <div className="container mx-auto px-6 pt-10 relative z-10 flex flex-col md:flex-row items-center gap-8">
        <div className="max-w-3xl mx-auto md:mx-0 flex-1">
          ...
          >
            Over 9 years of experience crafting engaging frontend experiences
            for major web hosting brands. Passionate about clean code,
            responsive designs, and optimizing user experiences.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <span>poonamthite6@gmail.com</span>
            </a>
          </motion.div>
        </div>
      ...
      <div className="absolute top-32 -left-16 w-72 h-72 bg-secondary-100 rounded-full opacity-50 blur-3xl"></div>
    </section>
  );
};
